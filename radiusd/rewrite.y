        ...
        char *ptr;
{
        ...
        RWSTYPE delta = (len + sizeof(rw_rt.code[0])) / sizeof(rw_rt.code[0]);
        ...
        int   len;
{
        ...
        pushn((RWSTYPE) (rw_rt.stack + rw_rt.ht + 1));
}
...
rw_pushn()
{
        RWSTYPE n = (RWSTYPE) rw_rt.code[rw_rt.pc++];
        pushn(n);
}
...
rw_pushs()
{
        ...
        RWSTYPE *sptr = (RWSTYPE*) (rw_rt.code + rw_rt.pc);
